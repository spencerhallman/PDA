      ...
      ***************************************************************** 00780000
       ...
       01  WS-MISCELLANEOUS-FIELDS.                                     00800000
           ...
           05  WS-PROCESS-COUNT        PIC S9(9) COMP-3 VALUE 9000000.  00961002
           EJECT                                                        00970000
      ...
      ***************************************************************** 02250000
       ...
       P00000-MAINLINE.                                                 02270000
           ...
           MOVE WS-DATE-YEAR TO WS-RT-YEAR.                             02320000
                                                                        02330000
           PERFORM  P00500-DATE-PROCESS                                 02331000
               THRU P00500-EXIT WS-PROCESS-COUNT TIMES.                 02332000
                                                                        02333000
      ...
      ***************************************************************** 02563000
      *                                                               * 02564000
      *    PARAGRAPH:  P00500-PROCESS-DATE                            * 02565000
      *                                                               * 02566000
      *    FUNCTION :  OBTAIN AND PROCESS AND CURRENT DATE            * 02567000
      *                                                               * 02568000
      *    CALLED BY:  P00000-MAINLINE                                * 02569000
      *                                                               * 02569100
      ***************************************************************** 02569200
                                                                        02569300
       P00500-DATE-PROCESS.                                             02569400
                                                                        02569500
           MOVE FUNCTION CURRENT-DATE(1:8) TO WS-DATE.                  02569600
           MOVE WS-DATE-MONTH TO WS-RT-MONTH.                           02569700
           MOVE WS-DATE-DAY TO WS-RT-DAY.                               02569800
           MOVE WS-DATE-YEAR TO WS-RT-YEAR.                             02569900
                                                                        02572300
       P00500-EXIT.                                                     02572400
           EXIT.                                                        02572500
           EJECT                                                        02572600
      ***************************************************************** 02573000
      *                                                               * 02580000
