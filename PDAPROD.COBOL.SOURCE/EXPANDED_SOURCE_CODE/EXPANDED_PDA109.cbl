      ...
      *    CUSTOMER ARRAY                                             *
      *                                                               *
      *    NOTE: MAINTAIN ARRAY IN ALPHABETICAL ORDER BY CUSTOMER     *
      *          IDENTIFICATION (WCAR-CUSTOMER-ID)                    *
      *****************************************************************
      ...
      *****************************************************************
           ...
           05  FILLER                  PIC X(64)    VALUE
               'AMERICAN FASTNERS, INC.'.
           05  FILLER                  PIC X(128)   VALUE
               '9129 E. US HIGHWAY 36'.
           05  FILLER                  PIC X(32)    VALUE
               'AVON'.
           05  FILLER                  PIC X(32)    VALUE
               'INDIANA'.
      ...
      *****************************************************************
           ...
           05  FILLER                  PIC X(32)    VALUE SPACES.
           05  FILLER                  PIC X(64)    VALUE
               'ANCHOR FENCE WHOLESALERS OF MIAMI'.
           05  FILLER                  PIC X(128)   VALUE
               '3670 NW 79TH'.
           05  FILLER                  PIC X(32)    VALUE
               'MIAMI'.
      ...
      *****************************************************************
           ...
           05  FILLER                  PIC X(32)    VALUE SPACES.
           05  FILLER                  PIC X(64)    VALUE
               'BEST BOLTS AND SUPPLIES'.
           05  FILLER                  PIC X(128)   VALUE
               '32395 CLINTON KEITH RD. B7 #242'.
           05  FILLER                  PIC X(32)    VALUE
               'WILDOMAR'.
           05  FILLER                  PIC X(32)    VALUE
               'CALIFORNIA'.
      ...
      *****************************************************************
           ...
           05  FILLER                  PIC X(32)    VALUE SPACES.
           05  FILLER                  PIC X(64)    VALUE
               'HENGSHUI HENGZE FASTENING PART CO, LTD.'.
           05  FILLER                  PIC X(128)   VALUE
               'NO. 11 LIMIN RD.'.
           05  FILLER                  PIC X(32)    VALUE
               'HENGSHUI CITY'.
      ...
      *****************************************************************
       ...
       01  WS-CUSTOMER-ARRAY-R         REDEFINES WS-CUSTOMER-ARRAY.
           05  WCAR-CUSTOMERS          OCCURS 13 TIMES.
               10  WCAR-CUSTOMER-ID    PIC X(32).
               10  WCAR-CUSTOMER-PASSWORD
                                       PIC X(32).
               10  WCAR-CUSTOMER-NAME  PIC X(64).
               10  WCAR-CUSTOMER-ADDRESS
                                       PIC X(128).
               10  WCAR-CUSTOMER-CITY  PIC X(32).
               10  WCAR-CUSTOMER-STATE PIC X(32).
               10  WCAR-CUSTOMER-ZIP   PIC X(12).
               10  WCAR-SHIP-NAME      PIC X(64).
               10  WCAR-SHIP-ADDRESS   PIC X(128).
               10  WCAR-SHIP-CITY      PIC X(32).
               10  WCAR-SHIP-STATE     PIC X(32).
               10  WCAR-SHIP-ZIP       PIC X(12).
               10  WCAR-CUSTOMER-EMAIL PIC X(128).
           EJECT
      *END CUSARRAY.
           EJECT
      ...
      *COPY PCBORDE1.
      ****************************************************************  00000100
      *****  PCB FOR THE ORDER DATABASE                                 00000200
      ****************************************************************  00000300
       01  ORDER-PCB1.                                                  00000402
           05  OP1-DBDNAME             PIC X(8).                        00000501
           05  OP1-SEG-LEVEL           PIC XX.                          00000601
           05  OP1-STATUS              PIC XX.                          00000701
           05  FILLER                  PIC X(8).                        00000800
           05  OP1-SEG-NAME            PIC X(8).                        00000901
           05  FILLER                  PIC X(8).                        00001000
           05  OP1-FEEDBACK-AREA       PIC X(80).                       00002001
      *END PCBORDE1.
           EJECT
      ...
      *****************************************************************
           ...
           MOVE ZEROES                 TO PURCHASE-TYPE-PREFIX.
